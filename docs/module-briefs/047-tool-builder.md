...
Workspace home: packages/tool-builder
Targets: All
Test layers: T1, T9

## Purpose

Factory `buildTool()` w/ fail-closed defaults.
...
`claude-code/.../Tool.ts` `buildTool` factory

Research focus: Default safety posture
