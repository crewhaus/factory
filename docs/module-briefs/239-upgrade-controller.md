...
Workspace home: not created yet; likely packages/upgrade-controller unless folded into a target bundle
Targets: CLI, CHN, MGD
Test layers: T1, T3

## Purpose

In-place runtime upgrades, gradual rollout, version pinning.
...
`claude-code/.../utils/autoUpdater.ts`

Research focus: Update channels; pinning semantics
