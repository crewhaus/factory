...
Workspace home: not created yet; likely packages/branch-explorer unless folded into a target bundle
Targets: RES
Test layers: T1, T3, T6

## Purpose

Explore multiple research branches in parallel; rank/prune.
...
`langgraph` branching; subagent fan-out

Research focus: Branch budget; ranking
