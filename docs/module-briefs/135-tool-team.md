...
Workspace home: not created yet; likely packages/tool-team unless folded into a target bundle
Targets: CLI, CRW
Test layers: T1, T3
...
`claude-code/.../tools/TeamCreateTool`,`TeamDeleteTool`

Research focus: Team invite flow
