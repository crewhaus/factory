...
Workspace home: not created yet; likely packages/streaming-tool-executor unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T3, T7

## Purpose

Execute tools while model still streaming.
...
Research focus: Partial-args parsing; sibling abort
