...
Workspace home: not created yet; likely packages/compaction-microcompact unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T4

## Purpose

Cached per-tool-use-id compaction.
...
`claude-code/.../services/compact/microCompact.ts`,`apiMicrocompact.ts`

Research focus: Cache key design
