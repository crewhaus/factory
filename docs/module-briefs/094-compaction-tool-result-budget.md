# compaction-tool-result-budget

Status: planned
Dependency phase: 8 - Context & memory
Catalog layer: R6 - Context & Memory
Origin in ordering: expanded from compaction stack
Workspace home: not created yet; likely packages/compaction-tool-result-budget unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T9

## Purpose

Per-message aggregate-tool-result budget; persist overflow.
...
Research focus: Budget allocation strategy
