...
Workspace home: not created yet; likely packages/tool-lsp unless folded into a target bundle
Targets: CLI
...
`claude-code/.../tools/LSPTool/`; `claude-code/.../services/lsp/`

Research focus: LSP capability discovery
