...
Workspace home: not created yet; likely packages/tool-plan-mode unless folded into a target bundle
Targets: CLI, RES
Test layers: T1, T3

## Purpose

Plan-mode entry/exit (read-only planning).
...
`claude-code/.../tools/EnterPlanModeTool`,`ExitPlanModeV2Tool`

Research focus: Plan file persistence
