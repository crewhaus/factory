...
Workspace home: not created yet; likely packages/pairing-flow unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Device pairing for mobile channels.
...
`openclaw/pairing/`; `openclaw/.../channels/plugins/pairing.ts`

Research focus: UX for QR pairing
