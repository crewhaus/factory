...
Workspace home: not created yet; likely packages/wizard unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T3

## Purpose

First-run profile selection, channel/auth setup.
...
`openclaw/wizard/`; gstack `setup`; `claude-code/.../screens/`

Research focus: State machine; backtracking; resumability
