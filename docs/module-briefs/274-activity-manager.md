...
Workspace home: not created yet; likely packages/activity-manager unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T3

## Purpose

Track user/idle/active state for UI hints, away-summaries.
...
`claude-code/.../utils/activityManager.ts`,`awaySummary.ts`

Research focus: Idle thresholds
