...
Workspace home: not created yet; likely packages/tool-task unless folded into a target bundle
Targets: CLI, CHN, CRW, RES
Test layers: T1, T3

## Purpose

Task lifecycle tool (create/get/list/update/stop).
...
`claude-code/.../tools/Task*Tool/`; `openclaw/tasks/`

Research focus: Task state model
