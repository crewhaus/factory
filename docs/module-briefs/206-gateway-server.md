...
Workspace home: not created yet; likely packages/gateway-server unless folded into a target bundle
Targets: CHN, MGD, BATCH
Test layers: T1, T2, T7, T8

## Purpose

HTTP+WebSocket+JSON-RPC server (App Server).
...
`openclaw/gateway/`; OpenAI Codex App Server JSON-RPC; `claude-code/.../server/`; `agent-framework/.../foundry_hosting/`

Research focus: Auth; rate limit
