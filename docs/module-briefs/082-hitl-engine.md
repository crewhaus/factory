...
Workspace home: not created yet; likely packages/hitl-engine unless folded into a target bundle
Targets: GRPH, MGD, CRW, RES
Test layers: T1, T3, T4

## Purpose

Human-in-the-loop interrupt/resume; approval gates.
...
`langgraph` HITL; `haystack/.../human_in_the_loop/`; `agent-framework/.../_request_info_mixin.py`; `crewAI/.../flow/human_feedback.py`

Research focus: Resumption tokens; UI hooks
