...
Workspace home: not created yet; likely packages/tool-process unless folded into a target bundle
Targets: CLI, CHN, BATCH
Test layers: T1, T3, T7

## Purpose

Long-running background processes; monitoring; log capture.
...
`openclaw/.../agents/bash-tools.process.ts`; `claude-code/.../utils/Shell.ts`

Research focus: PID tracking; reap policy
