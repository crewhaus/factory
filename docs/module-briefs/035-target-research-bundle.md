# target-research-bundle

Status: planned
Dependency phase: 2 - IR & Compiler
Catalog layer: F2 - Compiler & Codegen
Origin in ordering: inferred from catalog layer F2
Workspace home: not created yet; likely packages/target-research-bundle unless folded into a target bundle
Targets: **RES**
Test layers: T1, T4, T7

## Purpose

Codegen for autonomous research agent: planner, crawler, citation tracker, report writer.
...
`gstack-main/.../autoplan/`; CrewAI research flows; ADK research samples

Research focus: Long-horizon resumability; checkpoint-per-stage
