...
Workspace home: not created yet; likely packages/call-session unless folded into a target bundle
Targets: VOICE
Test layers: T1, T3

## Purpose

Call lifecycle: ring/answer/hold/transfer/hangup.
...
Twilio Voice; Vonage; Agora

Research focus: State machine
