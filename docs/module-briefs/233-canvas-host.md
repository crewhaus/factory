...
Workspace home: not created yet; likely packages/canvas-host unless folded into a target bundle
Targets: CHN
Test layers: T1, T2, T3

## Purpose

Canvas/A2UI rich-content surface server.
...
`openclaw/canvas-host/`; `agent-framework/.../ag_ui/`

Research focus: Widget vocabulary
