...
Workspace home: not created yet; likely packages/swarm-runtime unless folded into a target bundle
Targets: CRW, CLI
Test layers: T1, T3

## Purpose

Decentralized peer-to-peer team (tmux/iTerm/in-process/network).
...
`claude-code/.../utils/swarm/`; `openclaw/.../tasks/detached-task-runtime.ts`

Research focus: Discovery; consensus
