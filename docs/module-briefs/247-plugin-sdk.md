...
Workspace home: not created yet; likely packages/plugin-sdk unless folded into a target bundle
Targets: All
Test layers: T1, T2

## Purpose

Public typed surface for third-party tools, channels, models, graders, target backends.
...
`openclaw/plugin-sdk/`; `claude-code/.../plugins/`; LangChain integration; Haystack component decorator

Research focus: Stable contract surface; semver
