...
Workspace home: not created yet; likely packages/update-channel unless folded into a target bundle
Targets: CLI
Test layers: T1, T3

## Purpose

Auto-update / version channel selection.
...
`claude-code/.../utils/autoUpdater.ts`; `claude-code/.../utils/binaryCheck.ts`

Research focus: Channel semantics
