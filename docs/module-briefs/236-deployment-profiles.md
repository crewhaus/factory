...
Workspace home: not created yet; likely packages/deployment-profiles unless folded into a target bundle
Targets: All
Test layers: T1

## Purpose

Profile defs (local-dev, k8s, lambda, agent-engine, foundry, agentcore, hybrid-vpc).
