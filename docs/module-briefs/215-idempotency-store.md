...
Workspace home: not created yet; likely packages/idempotency-store unless folded into a target bundle
Targets: BATCH, CHN
Test layers: T1, T7

## Purpose

Track processed message ids; exactly-once-ish semantics.
...
Common patterns; `temporal` workflow ids

Research focus: TTL; collision
