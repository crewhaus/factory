...
Workspace home: not created yet; likely packages/output-sink unless folded into a target bundle
Targets: BATCH
Test layers: T1, T2, T3

## Purpose

Write results to destination (DB / S3 / file / webhook).
...
Research focus: Sink abstraction
