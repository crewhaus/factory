...
Workspace home: not created yet; likely packages/media-service unless folded into a target bundle
Targets: CHN, CRW, VOICE
Test layers: T1, T2, T7

## Purpose

Image/audio/video handling, thumbnails, format conversion.
...
`openclaw/media/`,`media-understanding/`; `openclaw/.../agents/tool-images.ts`

Research focus: Codec matrix
