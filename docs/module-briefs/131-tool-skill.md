...
Workspace home: not created yet; likely packages/tool-skill unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T3

## Purpose

Read SKILL.md -> context.
...
`claude-code/.../tools/SkillTool`; `openclaw/.../agents/skills/serialize.ts`

Research focus: Frontmatter schema; conflict resolution
