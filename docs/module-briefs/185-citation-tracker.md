...
Workspace home: not created yet; likely packages/citation-tracker unless folded into a target bundle
Targets: RAG, RES
Test layers: T1, T5, T6

## Purpose

Track sources, quotes, evidence per claim.
...
`agent-framework/.../citations/`; OpenClaw citation refs

Research focus: Span-level vs doc-level
