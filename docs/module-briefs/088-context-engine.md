...
Workspace home: not created yet; likely packages/context-engine unless folded into a target bundle
Targets: CLI, CHN, CRW, GRPH, RES
Test layers: T1, T3

## Purpose

Pluggable context-management interface (bootstrap/maintain/ingest/assemble/compact).
...
`openclaw/context-engine/`; `claude-code/context.ts`

Research focus: Interface stability; named impls
