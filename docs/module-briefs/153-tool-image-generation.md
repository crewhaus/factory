...
Origin in ordering: inferred from catalog layer R4
Workspace home: not created yet; likely packages/tool-image-generation unless folded into a target bundle
Targets: CHN, CRW, RES
Test layers: T1, T2

## Purpose

Image gen (DALL-E/Flux).
...
`openclaw/.../image-generation/`; `openclaw/.../agents/tool-images.ts`

Research focus: Provider abstraction; safety filters
