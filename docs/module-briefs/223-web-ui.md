...
Workspace home: apps/web-ui or packages/web-ui
Targets: CHN, MGD, studio
Test layers: T1, T3

## Purpose

Web client for the harness (DevUI / Studio runtime view).
...
`agent-framework/.../devui/`; OpenAI Agent Builder; LangSmith Studio
