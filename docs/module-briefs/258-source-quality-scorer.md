...
Workspace home: not created yet; likely packages/source-quality-scorer unless folded into a target bundle
Targets: RES, RAG
Test layers: T1, T5

## Purpose

Score source credibility (domain authority, recency, citations).
...
TBD; common search QA patterns

Research focus: Score model
