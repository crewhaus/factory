...
Workspace home: not created yet; likely packages/tool-mcp unless folded into a target bundle
Targets: CLI, CHN, MGD, RES, BROW
Test layers: T1, T2, T3

## Purpose

Wrapper presenting external MCP tools as native tools.
...
`claude-code/.../services/mcp/`; `crewAI/.../tools/mcp_native_tool.py`; `openclaw/mcp/`

Research focus: Stdio vs SSE; auth handoff
