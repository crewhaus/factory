...
Workspace home: not created yet; likely packages/tool-orchestrator unless folded into a target bundle
Targets: CLI, CHN, CRW, MGD, GRPH, RES
...
`claude-code/.../services/tools/toolOrchestration.ts` (`partitionToolCalls`); `agent-framework/.../_executor.py`

Research focus: Concurrency-safety classification
