...
Workspace home: not created yet; likely packages/ingestion-pipeline unless folded into a target bundle
Targets: RAG, RES
Test layers: T1, T3, T7

## Purpose

Crawl -> load -> chunk -> embed -> store.
...
`llama_index/.../ingestion/`; `haystack` pipelines

Research focus: Incremental update; dedup
