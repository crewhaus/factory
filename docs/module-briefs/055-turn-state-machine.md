...
Workspace home: packages/turn-state-machine
Targets: All
Test layers: T1, T9

## Purpose

Transitions: need_model / need_tools / need_compaction / need_recovery / done.
...
`claude-code/query.ts` `State`/`Continue` pattern

Research focus: Transition diagram; invariant checks
