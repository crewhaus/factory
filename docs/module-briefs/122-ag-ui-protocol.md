...
Workspace home: not created yet; likely packages/ag-ui-protocol unless folded into a target bundle
Targets: CLI, CHN, MGD
Test layers: T1, T2, T3

## Purpose

Agent-UI protocol streaming UI events (Codex App Server-style JSON-RPC).
...
`agent-framework/.../ag_ui/`; OpenAI Codex App Server JSON-RPC; `openclaw/.../canvas-host/a2ui*`

Research focus: Bidirectional event vocabulary
