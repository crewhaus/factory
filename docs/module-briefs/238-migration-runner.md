...
Workspace home: not created yet; likely packages/migration-runner unless folded into a target bundle
Targets: GRPH, MGD
Test layers: T1, T4

## Purpose

Run schema/state migrations across deployed runtime versions.
...
`claude-code/.../migrations/`; LangGraph checkpoint migrations

Research focus: Online vs offline migrations; rollback safety
