...
Workspace home: not created yet; likely packages/bundle-packager unless folded into a target bundle
Targets: All
Test layers: T1, T3

## Purpose

Package compiled artifacts to deployable form (Docker/OCI/npm/pypi/manifest.json).
...
OpenAI Codex container packaging; `agent-framework/.../foundry_hosting/`; `adk-python/.../platform/`

Research focus: OCI vs language-native packaging; layered caching
