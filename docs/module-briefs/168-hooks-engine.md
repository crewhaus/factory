...
Workspace home: not created yet; likely packages/hooks-engine unless folded into a target bundle
Targets: CLI, CHN, CRW, GRPH, MGD, RES, BATCH
Test layers: T1, T3

## Purpose

Lifecycle hooks (pre-tool/post-tool/stop/compact/session-start/etc.).
...
`openclaw/hooks/`; `claude-code/hooks/`; `agent-framework/.../_middleware.py`; `crewAI/.../hooks/`

Research focus: Hook lifecycle; user vs system hooks
