...
Workspace home: not created yet; likely packages/document-loader unless folded into a target bundle
Targets: RAG, CHN, RES
Test layers: T1, T2

## Purpose

Read PDF/DOCX/HTML/Notion/Drive into Documents.
...
`haystack/.../readers`; `llama_index/.../readers/`; `openclaw/markdown/`

Research focus: Format coverage
