...
Workspace home: not created yet; likely packages/batch-job-spec unless folded into a target bundle
Targets: BATCH
Test layers: T1, T2

## Purpose

Per-item job spec (input schema, output schema, timeout, retries).
