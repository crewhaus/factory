...
Workspace home: not created yet; likely packages/tool-loop-detection unless folded into a target bundle
Targets: CLI, CHN, CRW, GRPH, RES
Test layers: T1, T9

## Purpose

Detect repeated tool calls; prevent runaway.
...
`openclaw/.../agents/tool-loop-detection.ts`

Research focus: Hash window; false-positive rate
