...
Workspace home: not created yet; likely packages/workflow-engine unless folded into a target bundle
Targets: CRW, MGD, RES, BATCH
Test layers: T1, T3, T7

## Purpose

Async-event workflow runtime; pub/sub event bus, step decorators.
...
`crewAI/.../flow/`; `llama_index/.../workflow`; `adk-python/.../flows/`

Research focus: Event semantics; backpressure
