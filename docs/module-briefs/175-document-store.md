...
Workspace home: not created yet; likely packages/document-store unless folded into a target bundle
Targets: RAG, CHN, CRW, RES
Test layers: T1, T2, T7

## Purpose

Document storage abstraction (in-mem/FAISS/qdrant/pinecone/weaviate).
...
`haystack/.../document_stores/`; `llama_index/.../indices/`

Research focus: Backend selection; metadata filter
