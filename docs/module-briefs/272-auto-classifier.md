...
Workspace home: not created yet; likely packages/auto-classifier unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T5

## Purpose

Content classifier (`yoloClassifier`).
