...
Workspace home: packages/tool-validate
Targets: All
Test layers: T1, T2

## Purpose

Pre-permission input validation per tool (Zod/Pydantic).
...
`claude-code/.../Tool.ts` `validateInput`; `openai-agents/.../tool.py` schema

Research focus: Schema-validation error mapping
