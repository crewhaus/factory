...
Workspace home: not created yet; likely packages/tool-ask-user unless folded into a target bundle
Targets: CLI, CHN, CRW, VOICE
Test layers: T1, T3
...
`claude-code/.../tools/AskUserQuestionTool`

Research focus: Multi-select UX; preview rendering
