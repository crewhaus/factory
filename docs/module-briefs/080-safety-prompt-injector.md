# safety-prompt-injector

Status: planned
Dependency phase: 7 - Permission/policy
Catalog layer: R8 - Permission, Policy, Safety
Origin in ordering: named in Part G
Workspace home: not created yet; likely packages/safety-prompt-injector unless folded into a target bundle
Targets: All
Test layers: T1, T8

## Purpose

Inject safety/system-policy text.
...
Catalog tests: T1, T8. Primary risks: security boundaries and policy bypasses.
