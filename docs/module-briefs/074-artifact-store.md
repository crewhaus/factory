...
Workspace home: not created yet; likely packages/artifact-store unless folded into a target bundle
Targets: All except RAG-only
Test layers: T1, T3

## Purpose

Persist files, screenshots, patches, generated docs, reports.
...
OpenAI artifact APIs; `adk-python/.../artifacts/`; `openclaw/blob-store.ts`

Research focus: Content addressing; GC
