...
Workspace home: not created yet; likely packages/pipeline-engine unless folded into a target bundle
Targets: RAG
Test layers: T1, T3

## Purpose

Component pipeline DAG.
...
`haystack/.../core/`; `haystack/components/`; `llama_index/.../query_engine/`

Research focus: DAG validation; type-flow
