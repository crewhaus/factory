...
Workspace home: not created yet; likely packages/lsp-host unless folded into a target bundle
Targets: CLI
Test layers: T1, T2, T3

## Purpose

LSP client for code-tools.
...
`claude-code/.../services/lsp/`

Research focus: Server pooling
