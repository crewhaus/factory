...
Workspace home: not created yet; likely packages/bootstrap-runtime unless folded into a target bundle
Targets: CLI, CHN, VOICE
Test layers: T1, T3

## Purpose

First-run trust prompts, telemetry consent, settings init.
...
`claude-code/main.tsx` `init()`; `openclaw/bootstrap/`

Research focus: Consent flows
