...
Workspace home: not created yet; likely packages/skills-serializer unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T9

## Purpose

Render skills list into system prompt.
...
`openclaw/.../agents/skills/serialize.ts`; `claude-code/.../skills/loadSkillsDir.ts`

Research focus: Token budget for skill list
