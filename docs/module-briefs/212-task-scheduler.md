...
Workspace home: not created yet; likely packages/task-scheduler unless folded into a target bundle
Targets: CHN, CLI, RES
Test layers: T1, T3
...
`openclaw/tasks/`; `mcp__scheduled-tasks`

Research focus: Persistence
