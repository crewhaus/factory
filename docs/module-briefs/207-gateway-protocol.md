...
Workspace home: not created yet; likely packages/gateway-protocol unless folded into a target bundle
Targets: CHN, MGD
Test layers: T1, T2

## Purpose

Wire protocol (REST routes, WS messages, JSON-RPC methods).
...
`openclaw/.../gateway/protocol/`; OpenAI App Server protocol

Research focus: Versioning
