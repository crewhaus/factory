...
Workspace home: not created yet; likely packages/isolated-agent-runner unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Run a one-shot agent for cron/heartbeat in own session.
...
`openclaw/.../cron/isolated-agent/`

Research focus: Session reaping
