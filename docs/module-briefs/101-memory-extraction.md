...
Origin in ordering: inferred from catalog layer R6
Workspace home: not created yet; likely packages/memory-extraction unless folded into a target bundle
Targets: CHN, CLI, RES
...
Research focus: Extraction quality; PII
