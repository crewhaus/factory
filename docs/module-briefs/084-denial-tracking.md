...
Workspace home: not created yet; likely packages/denial-tracking unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T9

## Purpose

Count consecutive denials; fall back to ask.
...
`claude-code/.../utils/permissions/denialTracking.ts`; `claude-code/.../utils/autoModeDenials.ts`

Research focus: Threshold tuning
