...
Workspace home: not created yet; likely packages/tool-notification unless folded into a target bundle
Targets: CHN, RES, BATCH
Test layers: T1, T3

## Purpose

Push notification (slack/email/webhook to user).
...
`claude-code/.../tools/PushNotification`; `openclaw/.../agents/announce-idempotency.ts`

Research focus: Dedup; quiet hours
