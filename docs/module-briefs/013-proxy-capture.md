...
Workspace home: not created yet; likely packages/proxy-capture unless folded into a target bundle
Targets: EVAL, CLI
Test layers: T1, T8

## Purpose

HTTP proxy for capturing/replaying tool traffic.
...
`openclaw/.../proxy-capture/`; `openclaw/.../security/proxy-server.ts`

Research focus: Cert installation
