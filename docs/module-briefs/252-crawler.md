...
Workspace home: not created yet; likely packages/crawler unless folded into a target bundle
Targets: RES, RAG
Test layers: T1, T3, T7

## Purpose

Autonomous multi-page web crawl beyond simple fetch (frontier, dedup, polite).
...
`llama_index/.../readers/` web; common crawler patterns

Research focus: Politeness; cycle detection
