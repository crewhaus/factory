...
Workspace home: not created yet; likely packages/channel-discord unless folded into a target bundle
Targets: CHN
...
`openclaw/.../channels/plugins/discord*`

Research focus: Slash command interop
