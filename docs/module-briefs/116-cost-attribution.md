...
Workspace home: not created yet; likely packages/cost-attribution unless folded into a target bundle
Targets: All
Test layers: T1, T7

## Purpose

Attribute cost across run/agent/tool/tenant.
...
`AI-Harness-Systems.md` sectioncost

Research focus: Dimension model
