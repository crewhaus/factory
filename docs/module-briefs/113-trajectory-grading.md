...
Workspace home: not created yet; likely packages/trajectory-grading unless folded into a target bundle
Targets: EVAL, MGD, RES
Test layers: T1, T6

## Purpose

Grade tool choices / handoffs / approvals / safety on full trajectory.
