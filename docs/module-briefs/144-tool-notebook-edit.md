...
Workspace home: not created yet; likely packages/tool-notebook-edit unless folded into a target bundle
Targets: CLI, RAG
Test layers: T1, T3
...
`claude-code/.../tools/NotebookEditTool`

Research focus: nbformat compatibility
