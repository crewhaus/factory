...
Workspace home: not created yet; likely packages/policy-engine unless folded into a target bundle
Targets: CLI, CHN, MGD, BATCH
Test layers: T1, T3, T8

## Purpose

Side-effect classification, allowlists, regulated ops, audit.
