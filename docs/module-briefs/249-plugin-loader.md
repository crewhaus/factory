...
Workspace home: not created yet; likely packages/plugin-loader unless folded into a target bundle
Targets: All
Test layers: T1, T3, T8

## Purpose

Runtime activation, sandboxed import, capability gating.
...
`openclaw/.../plugins/activation-planner.ts`; `claude-code/.../services/plugins/`

Research focus: Lazy loading; sandboxing JS/Py imports
