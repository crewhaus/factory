...
Workspace home: not created yet; likely packages/graph-visualizer unless folded into a target bundle
Targets: GRPH, CRW, RAG, MGD
Test layers: T1, T3

## Purpose

Render IR or live workflow graph (mermaid/d3/xyflow).
...
LangGraph viz; MAF `_viz.py`; `openai-agents/.../visualization.py`

Research focus: Layout for typed graphs; live updates
