...
Workspace home: not created yet; likely packages/replay-store unless folded into a target bundle
Targets: EVAL, all CI
Test layers: T1, T4

## Purpose

Recorded runs for replay tests + regression.
...
`openai-agents/tracing/`; `dspy/cache.py`

Research focus: Determinism guarantees
