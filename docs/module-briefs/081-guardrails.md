...
Workspace home: not created yet; likely packages/guardrails unless folded into a target bundle
Targets: CHN, CRW, MGD, RES, VOICE
Test layers: T1, T3, T8

## Purpose

Input/output guardrails (PII, jailbreak, secret leak, NSFW).
