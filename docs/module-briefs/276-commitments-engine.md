...
Workspace home: not created yet; likely packages/commitments-engine unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Track agent commitments/promises across sessions.
