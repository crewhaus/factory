...
Workspace home: not created yet; likely packages/personalization-store unless folded into a target bundle
Targets: CHN
Test layers: T1, T8

## Purpose

User preference + identity store.
...
`openclaw/secrets/`; `openclaw/.../agents/auth-profiles/`

Research focus: Schema; consent
