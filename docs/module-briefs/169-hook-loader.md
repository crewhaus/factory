...
Workspace home: not created yet; likely packages/hook-loader unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T3

## Purpose

Discover hooks from settings.json, plugins, project files.
...
Research focus: Discovery order
