...
Workspace home: not created yet; likely packages/tool-monitor unless folded into a target bundle
Targets: CLI, CHN, BATCH
Test layers: T1, T3, T7

## Purpose

Stream lines from long-running process as notifications.
...
`claude-code/.../tools/MonitorTool`

Research focus: Backpressure
