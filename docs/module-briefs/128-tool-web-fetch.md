...
Origin in ordering: expanded from tool-web-*
Workspace home: not created yet; likely packages/tool-web-fetch unless folded into a target bundle
Targets: CLI, CHN, CRW, RAG, RES
Test layers: T1, T2, T8

## Purpose

URL fetch, content extraction, link understanding.
...
`openclaw/.../web-fetch/`; `openclaw/.../link-understanding/`; `claude-code/.../tools/WebFetchTool`

Research focus: Robots.txt; sniff; redirect cycles
