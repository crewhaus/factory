...
Workspace home: not created yet; likely packages/tui-keybindings unless folded into a target bundle
Targets: CLI
Test layers: T1, T9

## Purpose

Customizable keybindings (chord support).
