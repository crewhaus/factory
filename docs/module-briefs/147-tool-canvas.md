...
Workspace home: not created yet; likely packages/tool-canvas unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

UI-canvas-as-tool (rich-content surface).
...
Research focus: Canvas widget vocabulary
