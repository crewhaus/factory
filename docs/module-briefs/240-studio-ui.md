...
Workspace home: apps/studio or packages/studio-ui
Targets: All (authoring)
Test layers: T1, T3

## Purpose

Visual editor: graph layout, tool wiring, channel binding, eval suite editor.
...
`agent-framework/.../devui/`; OpenAI Agent Builder; LangSmith Studio; CrewAI AMP UI

Research focus: Graph layout algos; collaborative edit OT/CRDT
