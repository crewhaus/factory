...
Workspace home: not created yet; likely packages/tool-agent unless folded into a target bundle
Targets: CLI, CRW, MGD, RES
Test layers: T1, T3, T6

## Purpose

Subagent spawn (`AgentTool`).
...
`claude-code/.../tools/AgentTool/`; `adk-python/.../agents/`; `openai-agents/.../_agent.py`

Research focus: Context filtering; tool restriction
