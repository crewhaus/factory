...
Workspace home: not created yet; likely packages/structured-output-tools unless folded into a target bundle
Targets: EVAL, MGD
Test layers: T1, T2

## Purpose

Tools that emit typed structured output (graders, classifiers).
...
`dspy/.../predict/`; `claude-code/.../tools/SyntheticOutputTool`

Research focus: Schema reuse
