...
Type-check, resolve refs, verify tool/agent/model existence, profile constraints.
...
`agent-framework/.../_validation.py`, `langgraph/_validate.py`, `haystack/.../Pipeline.validate`

Research focus: Cross-module ref resolution; profile constraint propagation
