...
Workspace home: not created yet; likely packages/channel-bluebubbles unless folded into a target bundle
Targets: CHN
...
`openclaw/.../channels/plugins/bluebubbles*`

Research focus: Mac dependency
