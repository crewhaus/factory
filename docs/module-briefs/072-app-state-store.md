...
Workspace home: not created yet; likely packages/app-state-store unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T3

## Purpose

Monolithic typed `AppState` for running harness.
...
Research focus: State tree shape
