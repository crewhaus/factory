...
Workspace home: not created yet; likely packages/target-channel-bot unless folded into a target bundle
Targets: **CHN**
Test layers: T1, T3

## Purpose

Codegen for channel assistant: gateway, channel adapters, cron, daemon.
...
`openclaw/gateway/`, `openclaw/daemon/`, `openclaw/channels/`

Research focus: Service shape; multi-channel orchestration
