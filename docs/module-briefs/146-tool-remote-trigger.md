...
Workspace home: not created yet; likely packages/tool-remote-trigger unless folded into a target bundle
Targets: CHN, CRW, BATCH
Test layers: T1, T2, T8

## Purpose

Trigger external URL/webhook with payload.
...
`claude-code/.../tools/RemoteTriggerTool`

Research focus: Auth; idempotency keys
