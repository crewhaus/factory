...
Workspace home: not created yet; likely packages/target-browser-driver unless folded into a target bundle
Targets: **BROW**
Test layers: T1, T3

## Purpose

Codegen for computer-use/browser-only agent: screen-grab loop, action driver, vision grounding.
...
`mcp__computer-use__*`, `mcp__Claude_in_Chrome__*`, OpenAI Operator-style refs

Research focus: Action latency budget; screenshot frequency
