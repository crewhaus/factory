...
Workspace home: not created yet; likely packages/channel-signal unless folded into a target bundle
Targets: CHN
...
`openclaw/.../channels/plugins/signal*`

Research focus: Signal-CLI integration
