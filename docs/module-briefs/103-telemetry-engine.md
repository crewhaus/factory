...
Workspace home: not created yet; likely packages/telemetry-engine unless folded into a target bundle
Targets: All
Test layers: T1, T7

## Purpose

Structured logging, metrics, OpenTelemetry spans.
...
`agent-framework/.../observability.py`,`_telemetry.py`; `openai-agents/.../tracing/`; `openclaw/logging/`; `claude-code/.../services/internalLogging.ts`; `haystack/.../tracing/`

Research focus: Span vocabulary; sampling
