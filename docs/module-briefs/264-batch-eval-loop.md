...
Workspace home: not created yet; likely packages/batch-eval-loop unless folded into a target bundle
Targets: BATCH, EVAL
Test layers: T1, T5

## Purpose

Tie batch worker to eval-service for online metric tracking.
...
Research focus: Metric streaming
