...
Workspace home: not created yet; likely packages/channel-binding unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Session <-> channel-conversation mapping.
...
Research focus: Identity collisions
