...
Workspace home: not created yet; likely packages/pii-redactor unless folded into a target bundle
Targets: CHN, MGD, VOICE
Test layers: T1, T5, T8

## Purpose

Detect/redact PII in inputs, outputs, logs.
...
`openai-agents/guardrails`; common DLP libs

Research focus: Recall vs precision
