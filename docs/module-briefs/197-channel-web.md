...
Workspace home: not created yet; likely packages/channel-web unless folded into a target bundle
Targets: CHN
...
`openclaw/.../channels/web/`; `openclaw/.../canvas-host/`

Research focus: Streaming over WS
