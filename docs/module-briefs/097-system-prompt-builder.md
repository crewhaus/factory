...
Workspace home: not created yet; likely packages/system-prompt-builder unless folded into a target bundle
Targets: All
Test layers: T1, T9

## Purpose

Composable sections (identity/tooling/safety/skills/messaging/runtime/extras), token-budget-aware.
...
`openclaw/.../agents/system-prompt.ts` (anti-pattern: 720-line god fn); `claude-code/context.ts`

Research focus: Section composition; per-section budget
