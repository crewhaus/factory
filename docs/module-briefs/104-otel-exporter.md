...
Workspace home: not created yet; likely packages/otel-exporter unless folded into a target bundle
Targets: All
Test layers: T1, T2

## Purpose

OTLP exporter to backends (Jaeger/Honeycomb/DataDog/Azure Monitor/Cloud Trace).
