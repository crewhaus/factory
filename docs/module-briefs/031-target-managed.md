...
Workspace home: not created yet; likely packages/target-managed unless folded into a target bundle
Targets: **MGD**
Test layers: T1, T3

## Purpose

Codegen for managed runtime bundles (Anthropic Managed Agents, OpenAI Codex App Server, AgentCore, Foundry, Agent Engine).
...
Anthropic Managed Agents docs; OpenAI App Server JSON-RPC; AWS AgentCore; ADK platform

Research focus: Manifest format diversity; deploy artifact shape
