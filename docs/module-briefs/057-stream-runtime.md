...
Workspace home: not created yet; likely packages/stream-runtime unless folded into a target bundle
Targets: All
Test layers: T1, T3, T7

## Purpose

Generator composition: provider stream -> orchestrator -> consumer.
...
`claude-code/.../services/tools/StreamingToolExecutor.ts`; `openai-agents/.../stream_events.py`; `langgraph/.../streaming`

Research focus: Backpressure; multi-consumer fanout
