...
Workspace home: not created yet; likely packages/tool-citations unless folded into a target bundle
Targets: RAG, RES, CHN
Test layers: T1, T5

## Purpose

Manage citation/source-attribution metadata in tool calls.
...
`agent-framework/.../citations/`; `openclaw/.../citations/` (if present); `claude-code/.../citations/`

Research focus: Span vs doc-level; cross-source merging
