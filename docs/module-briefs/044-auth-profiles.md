...
Workspace home: not created yet; likely packages/auth-profiles unless folded into a target bundle
Targets: All
Test layers: T1, T2, T8

## Purpose

Multi-provider creds (API keys, OAuth, IAM roles); profile switching; rotation.
...
`openclaw/.../agents/auth-profiles/`; `claude-code/.../utils/auth.ts`; `claude-code/.../services/oauth/`

Research focus: Secure storage; OAuth flow framework
