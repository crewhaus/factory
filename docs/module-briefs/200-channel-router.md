...
Workspace home: not created yet; likely packages/channel-router unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Outbound message routing (which channel for which session).
...
Research focus: Fallback/preferences
