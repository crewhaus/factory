...
Workspace home: not created yet; likely packages/daemon-process unless folded into a target bundle
Targets: CHN, BATCH
Test layers: T1, T7

## Purpose

Long-running process manager, IPC, supervisor.
