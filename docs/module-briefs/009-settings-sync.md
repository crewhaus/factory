...
Workspace home: not created yet; likely packages/settings-sync unless folded into a target bundle
Targets: CLI, CHN, MGD
Test layers: T1, T3

## Purpose

Multi-source settings merge (project/user/enterprise/policy).
...
`claude-code/.../services/settingsSync/`,`remoteManagedSettings/`,`policyLimits/`

Research focus: Precedence rules
