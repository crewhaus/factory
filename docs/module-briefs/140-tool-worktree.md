...
Workspace home: not created yet; likely packages/tool-worktree unless folded into a target bundle
Targets: CLI
Test layers: T1, T3
...
`claude-code/.../tools/EnterWorktreeTool`,`ExitWorktreeTool`

Research focus: Cleanup safety
