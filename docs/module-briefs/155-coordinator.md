...
Workspace home: not created yet; likely packages/coordinator unless folded into a target bundle
Targets: CRW, CLI, RES
Test layers: T1, T3, T6

## Purpose

Centralized coordinator (manager -> workers).
...
`claude-code/.../coordinator/`; `crewAI/.../process.py`; `autogen/.../magentic-one`; `agent-framework/.../orchestrations/`

Research focus: Task assignment; aggregation
