...
Workspace home: not created yet; likely packages/barge-in-controller unless folded into a target bundle
Targets: VOICE
Test layers: T1, T3

## Purpose

Handle user interruption mid-speech.
...
`openai-agents/.../realtime/`; common voice agent patterns

Research focus: Cancel + roll-back
