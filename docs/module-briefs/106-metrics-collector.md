...
Workspace home: not created yet; likely packages/metrics-collector unless folded into a target bundle
Targets: All
Test layers: T1, T7

## Purpose

Counters, histograms, p50/p95 latency, error rate, cost.
...
Research focus: Dimension cardinality
