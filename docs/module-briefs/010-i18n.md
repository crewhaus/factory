...
Workspace home: not created yet; likely packages/i18n unless folded into a target bundle
Targets: CHN, VOICE
Test layers: T1, T9
...
`openclaw/i18n/`; `crewAI/translations/`

Research focus: Locale negotiation
