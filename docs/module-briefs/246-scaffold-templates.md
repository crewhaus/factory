...
Workspace home: not created yet; likely packages/scaffold-templates unless folded into a target bundle
Targets: All
Test layers: T1

## Purpose

Built-in spec templates per target shape.
...
gstack slash-commands as ref; `openclaw` profiles

Research focus: Template parameterization; conventions
