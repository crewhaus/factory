...
Workspace home: not created yet; likely packages/acp-protocol unless folded into a target bundle
Targets: CHN, MGD
Test layers: T1, T2

## Purpose

Agent Control Plane protocol (session policy, approvals, spawning).
...
Research focus: Control vs data plane split
