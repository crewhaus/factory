...
Workspace home: not created yet; likely packages/compaction-reactive unless folded into a target bundle
Targets: CLI, CHN, CRW, GRPH, MGD, RES
Test layers: T1, T4

## Purpose

Emergency compaction on 413 / prompt-too-long.
...
`claude-code/query.ts` reactive-compact branch

Research focus: Recovery loop bound
