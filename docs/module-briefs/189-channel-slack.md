...
Workspace home: not created yet; likely packages/channel-slack unless folded into a target bundle
Targets: CHN
...
`openclaw/.../channels/plugins/slack*`

Research focus: Socket mode; Block Kit
