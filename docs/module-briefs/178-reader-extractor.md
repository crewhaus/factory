...
Workspace home: not created yet; likely packages/reader-extractor unless folded into a target bundle
Targets: RAG
Test layers: T1, T5

## Purpose

Extract spans/answer from retrieved docs.
...
`haystack/.../readers`; `llama_index/.../extractors/`

Research focus: Extractive vs abstractive
