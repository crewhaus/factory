...
Workspace home: not created yet; likely packages/deployment-controller unless folded into a target bundle
Targets: All
Test layers: T1, T3

## Purpose

Deploy bundles to local / self-hosted / managed / hybrid.
...
LangSmith Deployment; ADK Cloud Run / Agent Engine; AgentCore; CrewAI AMP; Foundry

Research focus: Common deploy abstraction across radically different platforms
