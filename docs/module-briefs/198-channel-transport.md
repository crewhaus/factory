...
Workspace home: not created yet; likely packages/channel-transport unless folded into a target bundle
Targets: CHN
Test layers: T1, T7

## Purpose

Stall watchdog, retries, batching.
...
`openclaw/.../channels/transport/`

Research focus: Watchdog timeouts
