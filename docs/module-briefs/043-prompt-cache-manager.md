...
Workspace home: not created yet; likely packages/prompt-cache-manager unless folded into a target bundle
Targets: All
Test layers: T1, T4

## Purpose

Prompt-cache stability: contiguous tool prefixes, cache-friendly system prompts, cache breakpoints.
...
`claude-code/tools.ts` (built-ins prefix); Anthropic prompt-caching docs

Research focus: Provider cache semantics; breakpoint placement
