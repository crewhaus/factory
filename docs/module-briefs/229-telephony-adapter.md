...
Workspace home: not created yet; likely packages/telephony-adapter unless folded into a target bundle
Targets: VOICE
Test layers: T1, T2, T3

## Purpose

Telephony provider integration (Twilio/Vonage/Plivo/SIP).
...
Research focus: SIP vs HTTP webhook
