...
Origin in ordering: expanded from channel-*
Workspace home: not created yet; likely packages/channel-whatsapp unless folded into a target bundle
Targets: CHN
Test layers: T1, T2, T3

## Purpose

WhatsApp adapter (cloud API + linked devices).
...
`openclaw/.../channels/plugins/whatsapp*`

Research focus: Cloud API vs Business
