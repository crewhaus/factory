...
Workspace home: packages/tool-permission-matcher
Targets: All
Test layers: T1, T9

## Purpose

Pattern matchers for permission rules (`Bash(git *)`).
...
`claude-code/.../utils/permissions/preparePermissionMatcher`

Research focus: Glob vs regex; pattern composition
