...
Workspace home: not created yet; likely packages/prompt-injection-detector unless folded into a target bundle
Targets: All
Test layers: T1, T8

## Purpose

Detect/mitigate prompt injection in tool outputs.
