...
Workspace home: not created yet; likely packages/state-store unless folded into a target bundle
Targets: All
Test layers: T1, T9

## Purpose

In-process state container (zustand-style); referential equality, listeners.
...
`claude-code/.../state/store.ts` (40 lines)

Research focus: Observers; immutability
