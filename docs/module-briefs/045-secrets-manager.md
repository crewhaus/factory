...
Workspace home: not created yet; likely packages/secrets-manager unless folded into a target bundle
Targets: All
Test layers: T1, T2, T8

## Purpose

Read/decrypt secrets (env / keychain / vault / cloud KMS).
...
`openclaw/secrets/`; `claude-code/.../utils/auth.ts`; `agent-framework/.../_settings.py`

Research focus: Backend abstraction; rotation
