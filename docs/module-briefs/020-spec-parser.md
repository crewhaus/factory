...
Parse, lint, resolve includes/macros/overlays -> AST.
...
`langgraph/_validate.py`, `haystack` pipeline YAML loader, `crewAI/.../flow_serializer.py`

Research focus: Include/import semantics; cyclic detection; overlay merging
