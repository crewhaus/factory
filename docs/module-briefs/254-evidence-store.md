...
Workspace home: not created yet; likely packages/evidence-store unless folded into a target bundle
Targets: RES, RAG
Test layers: T1, T5

## Purpose

Accumulate evidence with metadata (source, timestamp, claim, support level).
...
`agent-framework/.../citations/`; KG-style stores

Research focus: Dedup; conflict resolution
