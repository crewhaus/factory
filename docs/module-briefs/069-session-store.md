...
Workspace home: not created yet; likely packages/session-store unless folded into a target bundle
Targets: All
Test layers: T1, T3, T7

## Purpose

Short-term session state, identity, lifecycle.
...
`openclaw/sessions/`; `claude-code/.../utils/sessionStorage.ts`; `agent-framework/.../_sessions.py`; `adk-python/.../sessions/`; `openai-agents/.../memory/session.py`

Research focus: TTL; eviction; identity model
