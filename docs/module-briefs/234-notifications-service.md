...
Workspace home: not created yet; likely packages/notifications-service unless folded into a target bundle
Targets: CLI, CHN, RES, BATCH
Test layers: T1, T3

## Purpose

Cross-app notifications (system tray, OS, push).
...
`claude-code/.../services/notifier.ts`,`hooks/notifs/`

Research focus: OS abstraction
