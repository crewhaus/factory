...
Workspace home: not created yet; likely packages/startup-profiler unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T7

## Purpose

Startup-time profiling, deferred prefetches, eager loads.
...
`claude-code/main.tsx` `profileCheckpoint()`,`startDeferredPrefetches()`

Research focus: Critical path
