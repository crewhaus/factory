...
Workspace home: not created yet; likely packages/module-marketplace unless folded into a target bundle
Targets: All
Test layers: T1, T2

## Purpose

Optional remote registry for sharing modules (tools/skills/channels/graders).
...
npm/PyPI; HuggingFace Hub; OpenAI tool registry

Research focus: Federation; trust; metadata schema
