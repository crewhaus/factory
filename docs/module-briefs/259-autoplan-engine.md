...
Workspace home: not created yet; likely packages/autoplan-engine unless folded into a target bundle
Targets: CLI, CRW, RES
Test layers: T1, T6

## Purpose

Plan-then-act: dedicated planning model produces plan consumed by executor.
...
`gstack-main/.../autoplan/`; `claude-code/.../tools/EnterPlanModeTool`

Research focus: Plan format

## Validation Plan

Catalog tests: T1, T6. Primary risks: quality regressions that only show up through eval or trace grading.
