...
Workspace home: not created yet; likely packages/tool-browser unless folded into a target bundle
Targets: CLI, CHN, CRW, RES, BROW
Test layers: T1, T3, T7, T8

## Purpose

Stateful browser automation (Playwright/Chromium).
...
`claude-code/.../tools/WebBrowserTool`; `openclaw/.../canvas-host/`; OpenAI Agents browser

Research focus: Session pooling; isolation
