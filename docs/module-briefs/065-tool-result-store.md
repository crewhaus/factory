...
Workspace home: not created yet; likely packages/tool-result-store unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T3

## Purpose

Persist large tool outputs to disk; preview to model.
...
Research focus: Preview shape; addressing scheme
