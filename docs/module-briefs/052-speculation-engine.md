...
Workspace home: not created yet; likely packages/speculation-engine unless folded into a target bundle
Targets: CLI, RES
Test layers: T1, T7

## Purpose

Speculative decoding / pre-fetch of likely-next-tool.
...
`claude-code/.../state/AppStateStore.ts` `speculation`

Research focus: Speculation hit-rate; rollback cost
