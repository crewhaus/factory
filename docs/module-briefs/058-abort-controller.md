...
Workspace home: not created yet; likely packages/abort-controller unless folded into a target bundle
Targets: All
Test layers: T1, T3

## Purpose

Cooperative cancellation (parent vs sibling abort, child controllers per tool).
...
Research focus: AbortSignal threading; cleanup ordering
