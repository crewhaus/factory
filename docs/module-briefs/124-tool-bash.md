...
Workspace home: packages/tool-bash
Targets: CLI, CHN, BATCH, RES
Test layers: T1, T3, T8

## Purpose

Shell exec, background process mgmt, kill-tree.
...
`claude-code/.../tools/BashTool`; `openclaw/.../process/exec.ts`,`kill-tree.ts`

Research focus: Sandboxing; timeout; output buffering
