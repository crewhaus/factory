...
Workspace home: not created yet; likely packages/query-router unless folded into a target bundle
Targets: RAG, MGD
Test layers: T1, T3

## Purpose

Conditional pipeline branching (query type / language / topic).
...
`haystack/.../routers/`; `llama_index/.../selectors/`

Research focus: Classifier choice
