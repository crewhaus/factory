...
Workspace home: not created yet; likely packages/audit-log unless folded into a target bundle
Targets: MGD
Test layers: T1, T8

## Purpose

Tamper-evident audit trail (separate from event log).
...
AWS AgentCore observability; `openclaw/.../security/audit*.ts`

Research focus: Signing; rotation
