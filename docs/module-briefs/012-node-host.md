...
Workspace home: not created yet; likely packages/node-host unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Multi-host execution (run agent on phone/server/laptop).
...
`openclaw/node-host/`,`pairing/`

Research focus: Cross-host RPC
