...
Workspace home: not created yet; likely packages/tool-web-search unless folded into a target bundle
Targets: CLI, CHN, CRW, RAG, RES
Test layers: T1, T2

## Purpose

Brave/Bing/Google/X/Tavily providers.
...
`openclaw/web-search/`; `claude-code/.../tools/WebSearchTool`; `openai-agents/.../extensions/`

Research focus: Provider fallback; result normalization
