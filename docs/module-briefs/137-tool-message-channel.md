...
Workspace home: not created yet; likely packages/tool-message-channel unless folded into a target bundle
Targets: CHN
Test layers: T1, T2, T8

## Purpose

Send messages to other channels/sessions/users.
...
`openclaw/.../agents/channel-tools.ts`; `claude-code/.../tools/SendMessageTool`

Research focus: Cross-channel addressing
