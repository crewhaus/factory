...
Workspace home: not created yet; likely packages/tool-screen-capture unless folded into a target bundle
Targets: BROW, CLI
Test layers: T1, T3

## Purpose

Take screenshots / screen video.
...
`mcp__computer-use__screenshot`; `claude-code/.../tools/screenshot`

Research focus: Frame rate; diff detection
