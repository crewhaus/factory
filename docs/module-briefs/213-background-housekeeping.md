...
Workspace home: not created yet; likely packages/background-housekeeping unless folded into a target bundle
Targets: All
Test layers: T1, T7

## Purpose

Cache eviction, log rotation, FS GC.
...
`claude-code/.../utils/backgroundHousekeeping.ts`

Research focus: Cadence; pause-resume
