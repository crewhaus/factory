...
Workspace home: not created yet; likely packages/query-engine unless folded into a target bundle
Targets: All
Test layers: T1, T3

## Purpose

SDK/headless wrapper over orchestrator (`submitMessage()` async-gen).
...
Research focus: SDK message normalization
