...
Workspace home: not created yet; likely packages/retry-policy unless folded into a target bundle
Targets: All
Test layers: T1, T7

## Purpose

Backoff strategies (exp/jitter/circuit-breaker).
...
`agent-framework/.../_retry.py`; common patterns

Research focus: Failure taxonomy
