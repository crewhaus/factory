...
Workspace home: not created yet; likely packages/tool-memory unless folded into a target bundle
Targets: CHN, CRW, GRPH, RES
Test layers: T1, T5

## Purpose

Memory get/search tool.
...
`crewAI/.../memory/`; `openai-agents/.../memory/`; `agent-framework/.../mem0/`; `openclaw/.../agents/memory/`

Research focus: Recall ranking
