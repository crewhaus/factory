...
Workspace home: not created yet; likely packages/checkpoint-store unless folded into a target bundle
Targets: GRPH, MGD, CHN, RES
Test layers: T1, T4, T7

## Purpose

Resumable state snapshots (graph node state, branches, time-travel).
...
`langgraph/.../checkpoint/`; `agent-framework/.../_checkpoint.py`,`_checkpoint_encoding.py`; ADK sessions

Research focus: Encoding; partial save
