...
Workspace home: not created yet; likely packages/channel-registry unless folded into a target bundle
Targets: CHN
Test layers: T1
...
`openclaw/.../channels/registry.ts`,`ids.ts`

Research focus: Plugin loader integration
