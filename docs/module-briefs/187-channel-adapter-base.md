...
Workspace home: not created yet; likely packages/channel-adapter-base unless folded into a target bundle
Targets: CHN
Test layers: T1, T2
...
`openclaw/.../channels/types.ts`

Research focus: Capability model (text/media/buttons/threads)
