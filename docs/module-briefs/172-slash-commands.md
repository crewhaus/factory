...
Workspace home: not created yet; likely packages/slash-commands unless folded into a target bundle
Targets: CLI, CHN
Test layers: T1, T3

## Purpose

Define, parse, route, render slash commands.
...
`openclaw/commands/`; `claude-code/commands.ts`,`commands/`; gstack slash-command catalog

Research focus: Arg parsing; help
