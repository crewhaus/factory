...
Workspace home: not created yet; likely packages/tool-vision-grounding unless folded into a target bundle
Targets: BROW, CLI
Test layers: T1, T5, T6

## Purpose

Find on-screen elements by description (vision model + heuristics).
...
`mcp__Claude_in_Chrome__find`; OpenAI Operator-style

Research focus: Element-locator robustness
