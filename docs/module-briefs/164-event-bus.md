...
Workspace home: not created yet; likely packages/event-bus unless folded into a target bundle
Targets: CRW, MGD, GRPH
Test layers: T1, T3, T7

## Purpose

Internal event publishing for workflow/agents.
...
`crewAI/.../events/`; `llama_index/.../instrumentation/`

Research focus: Topic taxonomy; subscriber model
