...
Workspace home: not created yet; likely packages/tool-search unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T5

## Purpose

Deferred tool loading by keyword (saves tokens).
...
`claude-code/.../tools/ToolSearchTool/`; `Tool.ts` `shouldDefer`

Research focus: Index strategy; recall quality
