...
Workspace home: not created yet; likely packages/session-reaper unless folded into a target bundle
Targets: CHN, MGD
Test layers: T1, T7

## Purpose

Cleanup expired/orphaned sessions.
...
`openclaw/.../cron/isolated-agent/` reaper

Research focus: Eviction policy
