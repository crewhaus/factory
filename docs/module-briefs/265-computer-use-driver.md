...
Workspace home: not created yet; likely packages/computer-use-driver unless folded into a target bundle
Targets: BROW, CLI
Test layers: T1, T2, T3

## Purpose

Mouse/keyboard/screenshot drivers.
...
`mcp__computer-use__*`; OpenAI Operator

Research focus: Cross-OS abstraction
