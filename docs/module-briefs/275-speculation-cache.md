...
Workspace home: not created yet; likely packages/speculation-cache unless folded into a target bundle
Targets: CLI
Test layers: T1, T7

## Purpose

Cached predictions for speculative execution.
