...
Workspace home: not created yet; likely packages/compaction-context-collapse unless folded into a target bundle
Targets: CLI, CHN, GRPH, RES
Test layers: T1, T4
...
`claude-code/.../services/contextCollapse/`

Research focus: Projection schema
