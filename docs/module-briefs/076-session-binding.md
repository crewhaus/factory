...
Workspace home: not created yet; likely packages/session-binding unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Bind session <-> channel <-> thread <-> user.
