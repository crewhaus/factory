...
Workspace home: not created yet; likely packages/checkpoint-encoder unless folded into a target bundle
Targets: GRPH, MGD, RES
Test layers: T1, T4

## Purpose

Versioned encoding/decoding of checkpoint payloads.
...
`agent-framework/.../_checkpoint_encoding.py`; LangGraph serializers

Research focus: Schema evolution; size
