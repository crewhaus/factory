...
Workspace home: not created yet; likely packages/knowledge-graph unless folded into a target bundle
Targets: RAG, CRW, RES
Test layers: T1, T5

## Purpose

Optional KG layer over docs.
...
`crewAI/.../knowledge/`; `llama_index/.../graph_stores/`

Research focus: Triple extraction quality
