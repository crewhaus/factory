...
Workspace home: not created yet; likely packages/vad-engine unless folded into a target bundle
Targets: VOICE
Test layers: T1, T5, T7
...
OpenAI Realtime VAD; `webrtcvad`; Silero VAD

Research focus: Latency vs accuracy

## Validation Plan

Catalog tests: T1, T5, T7. Primary risks: load, long-run behavior, and storage pressure; quality regressions that only show up through eval or trace grading.
