...
Workspace home: not created yet; likely packages/replay-engine unless folded into a target bundle
Targets: EVAL, CLI, CHN, all CI
Test layers: T1, T4

## Purpose

Deterministic replay of recorded runs (fixtures + traces).
...
`dspy/cache.py`; `openai-agents/.../tracing/` replay

Research focus: Determinism boundaries
