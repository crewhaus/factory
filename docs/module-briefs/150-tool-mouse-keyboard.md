...
Workspace home: not created yet; likely packages/tool-mouse-keyboard unless folded into a target bundle
Targets: BROW
Test layers: T1, T3

## Purpose

Pixel-level mouse/keyboard input.
...
`mcp__computer-use__left_click` etc.; CC keyboard tools

Research focus: Coordinate normalization; key chord encoding
