...
Workspace home: not created yet; likely packages/benchmark-runner unless folded into a target bundle
Targets: EVAL
Test layers: T1, T7

## Purpose

Multi-task benchmark orchestration.
...
`helm/benchmark/`; lm-evaluation-harness runner

Research focus: Reproducibility
