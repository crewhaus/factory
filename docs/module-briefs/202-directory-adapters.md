...
Workspace home: not created yet; likely packages/directory-adapters unless folded into a target bundle
Targets: CHN
Test layers: T1, T3

## Purpose

Contact/group resolution per channel.
...
`openclaw/.../channels/plugins/directory-adapters.ts`

Research focus: Caching
