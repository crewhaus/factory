...
Workspace home: not created yet; likely packages/message-actions unless folded into a target bundle
Targets: CHN
Test layers: T1, T2

## Purpose

Reactions, edits, deletes, inline buttons.
...
`openclaw/.../channels/plugins/message-actions.ts`

Research focus: Per-channel feature matrix
