...
Workspace home: not created yet; likely packages/voice-runtime unless folded into a target bundle
Targets: VOICE
Test layers: T1, T2, T7

## Purpose

Realtime voice loop (audio in/out, VAD, speech sessions).
...
`claude-code/voice/`; `openai-agents/.../voice/`,`realtime/`; `openclaw/realtime-voice/`

Research focus: Provider abstraction
