...
Workspace home: not created yet; likely packages/progress-streamer unless folded into a target bundle
Targets: RES, BATCH
Test layers: T1, T3

## Purpose

Long-run progress reporting (since runs can be hours).
...
None directly - design

Research focus: Reporting cadence
