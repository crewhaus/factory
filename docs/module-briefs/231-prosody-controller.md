...
Workspace home: not created yet; likely packages/prosody-controller unless folded into a target bundle
Targets: VOICE, CHN
Test layers: T1, T2

## Purpose

Voice/speed/pause/SSML directives.
...
`openclaw/.../tts/directives.ts`

Research focus: SSML support
