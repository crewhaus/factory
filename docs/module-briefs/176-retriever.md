...
Workspace home: not created yet; likely packages/retriever unless folded into a target bundle
Targets: RAG, CHN, CRW, RES
Test layers: T1, T5

## Purpose

Retrieve docs by similarity / BM25 / hybrid / structured-query.
...
`haystack/.../retrievers/`; `llama_index/.../retrievers/`; `dspy/.../retrievers/`; `crewAI/.../rag/`

Research focus: Hybrid scoring; recency
