...
Workspace home: not created yet; likely packages/a2a-protocol unless folded into a target bundle
Targets: CRW, MGD
Test layers: T1, T2

## Purpose

Agent-to-Agent protocol client/server (Google A2A).
...
`agent-framework/.../a2a/`; `crewAI/.../a2a/`; `adk-python/.../a2a/`

Research focus: A2A message envelope; capability discovery
