...
Workspace home: not created yet; likely packages/fingerprint unless folded into a target bundle
Targets: EVAL, MGD
Test layers: T1, T4

## Purpose

Run/agent fingerprinting (deterministic build IDs, content-hashes).
...
`crewAI/.../security/fingerprint.py`; `claude-code/.../utils/attribution.ts`

Research focus: Hash granularity
