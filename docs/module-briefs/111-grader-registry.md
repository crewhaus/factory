...
Workspace home: not created yet; likely packages/grader-registry unless folded into a target bundle
Targets: EVAL
Test layers: T1, T5

## Purpose

Pluggable graders (exact-match/llm-judge/ragas-faithfulness/custom).
...
Research focus: Composition; calibration
