...
Workspace home: packages/run-context
Targets: All
Test layers: T1, T3

## Purpose

Per-run context object threaded through orchestrator/tools/policy.
...
`claude-code/.../Tool.ts` `ToolUseContext`; `openai-agents/.../run_context.py`

Research focus: What goes in context; immutability vs mutation
