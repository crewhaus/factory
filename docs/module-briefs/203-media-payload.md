...
Workspace home: not created yet; likely packages/media-payload unless folded into a target bundle
Targets: CHN
Test layers: T1, T2

## Purpose

Per-channel media limits, format conversion, payload framing.
...
`openclaw/.../channels/plugins/media-limits.ts`,`media-payload.ts`

Research focus: Transcoding
