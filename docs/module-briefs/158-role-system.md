...
Workspace home: not created yet; likely packages/role-system unless folded into a target bundle
Targets: CRW
Test layers: T1, T6

## Purpose

Role definitions (CrewAI-style: backstory/goal/agent-type), team composition.
...
`crewAI/.../agent`; `crewAI/.../crew.py`; `crewAI/crews/`

Research focus: Role schema; conflict
