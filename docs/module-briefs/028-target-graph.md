...
Workspace home: not created yet; likely packages/target-graph unless folded into a target bundle
Targets: **GRPH**, MGD, CRW
Test layers: T1, T4

## Purpose

Codegen for stateful graph runtime (LangGraph-shape) - node/edge/checkpoint config, durability mode.
...
`langgraph/.../pregel/`, `agent-framework/.../_workflows/_workflow.py`

Research focus: Pregel vs imperative; checkpoint scheme
