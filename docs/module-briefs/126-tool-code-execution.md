...
Workspace home: not created yet; likely packages/tool-code-execution unless folded into a target bundle
Targets: CLI, MGD, EVAL, RES, BATCH
Test layers: T1, T3, T7, T8

## Purpose

Sandboxed Python/JS REPL.
...
`claude-code/.../tools/REPLTool`; OpenAI Code Interpreter; Foundry CI; `adk-python/.../code_executors/`

Research focus: Container vs micro-VM; warm pool
