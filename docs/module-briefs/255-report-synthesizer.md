...
Workspace home: not created yet; likely packages/report-synthesizer unless folded into a target bundle
Targets: RES
Test layers: T1, T5, T6

## Purpose

Compose long-form structured report from evidence (markdown/PDF/docx).
...
`anthropic-skills:docx`; `anthropic-skills:pdf`; `dspy/.../predict/` long-form

Research focus: Outline generation; section budgeting
