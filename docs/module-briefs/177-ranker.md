...
Workspace home: not created yet; likely packages/ranker unless folded into a target bundle
Targets: RAG, RES
Test layers: T1, T5

## Purpose

Rerank retrieved docs (cross-encoder/LLM/fusion).
