...
Workspace home: not created yet; likely packages/target-workflow unless folded into a target bundle
Targets: **CRW**, MGD, RES
Test layers: T1, T4

## Purpose

Codegen for event-driven workflow target.
...
Research focus: Async event semantics; pub/sub vs typed channels
