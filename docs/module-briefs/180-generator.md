...
Workspace home: not created yet; likely packages/generator unless folded into a target bundle
Targets: RAG
Test layers: T1, T2

## Purpose

LLM call inside pipeline (with retrieved context).
...
`haystack/.../generators/`; `llama_index/.../llms/`

Research focus: Wraps `model-adapter`
