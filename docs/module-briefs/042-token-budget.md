...
Workspace home: packages/token-budget
Targets: All
Test layers: T1, T9

## Purpose

Track input/output tokens; per-message budgets; auto-continue thresholds.
...
`claude-code/.../query/tokenBudget.ts` (+500k auto-continue); `claude-code/.../utils/tokenEstimation.ts`

Research focus: Tokenizer parity across providers
