...
Workspace home: not created yet; likely packages/skills-registry unless folded into a target bundle
Targets: CLI, CHN, RES
Test layers: T1, T3

## Purpose

Skills catalog (lazy-loaded SKILL.md from workspace, plugins, bundled).
...
`openclaw/.../agents/skills/`; `claude-code/skills/`

Research focus: Lazy-loading; conflict
