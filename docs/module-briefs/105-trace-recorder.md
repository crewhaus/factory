...
Workspace home: not created yet; likely packages/trace-recorder unless folded into a target bundle
Targets: All
Test layers: T1, T7

## Purpose

Persist spans/traces locally (replay, grading).
...
`openai-agents/tracing/`; `agent-framework/.../foundry/` traces

Research focus: Storage size; rotation
