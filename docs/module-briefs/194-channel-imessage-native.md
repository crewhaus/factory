# channel-imessage-native

Status: planned
Dependency phase: 15 - Channels
Catalog layer: R13 - Channels & Messaging
Origin in ordering: expanded from channel-*
Workspace home: not created yet; likely packages/channel-imessage-native unless folded into a target bundle
Targets: CHN
...
`openclaw/.../channels/plugins/imessage*`

Research focus: AppleScript bridge
