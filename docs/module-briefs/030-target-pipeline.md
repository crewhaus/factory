...
Workspace home: not created yet; likely packages/target-pipeline unless folded into a target bundle
Targets: **RAG**
Test layers: T1, T3

## Purpose

Codegen for pipeline DAG.
...
`haystack/.../core/`, `haystack/components/`

Research focus: Component decorator; DAG scheduling
