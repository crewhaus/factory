...
Workspace home: not created yet; likely packages/mcp-server-host unless folded into a target bundle
Targets: CHN, MGD
Test layers: T1, T2, T8

## Purpose

Expose harness's tools as an MCP server.
...
`openclaw/.../canvas-host/server.ts`; LangSmith MCP exposure

Research focus: Surface filtering; auth
