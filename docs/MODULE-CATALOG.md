...
> Status as of 2026-05-06. 46 of ~190 catalog modules implemented across 41 workspace packages; full suite is 693 tests across 41 test files, all green; `tsc -b` clean. Sections 1–12 of `docs/build-roadmap.md` are landed; Sections 13–17 (sub-agents, expanded tool catalog, observability, eval stack, multi-provider models) are scoped but not started.
