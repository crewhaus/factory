...
// Source spec: ${ir.name} (target: crew, ir version: ${ir.version}, role: ${role.name})
...
${tableLit};
  ...
  return `// Generated by crewhaus-factory. DO NOT EDIT.
// Source spec: ${ir.name} (target: crew, ir version: ${ir.version}, file: orchestrator.ts)
...
// Source spec: ${ir.name} (target: crew, ir version: ${ir.version}, file: daemon.ts)
