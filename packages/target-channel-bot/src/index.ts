...
import type { Bundle, IrChannelV0, IrSecretRef } from "@crewhaus/ir";
...
${permImport}import type { HookDef } from "@crewhaus/hooks-engine";
  ...
  return {
    async runTurn(args: RunTurnArgs): Promise<string> {
      ...
      return await runChatLoop({
        ...
        slashCommands: config.slashCommands,${permField}
      });
    },
  };
}
...
${builtinImportBlock}${mcpImportBlock}import { createAgent } from "./agent.js";
