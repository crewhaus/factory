...
| Recalled wiki/fact bodies | `"memory"` | [packages/tool-wiki](packages/tool-wiki) (wiki reads, inside the tool); [packages/runtime-core](packages/runtime-core) (auto-recalled fact, wiki and session-summary lines, per line, before they enter the system region — `renderRecalledMemory`) |
